...
TNC_RRWallet.createTNCWallet = function(req,res) {
...
TNC_RRWallet.getTNCAddress = function(req,res) {
	var username = req.body.email;
	var res_data = {};
...
TNC_RRWallet.updateTNCWallet = function(req,res) {
...
TNC_RRWallet.transferTNCWallet = function(req,res) {
...
TNC_RRWallet.stakingInfo = function(req,res){
...
TNC_RRWallet.stakingTNCFund = function(req,res) {
...
TNC_RRWallet.transferTNCFund = function(req,res) {
...
TNC_RRWallet.getTNCStakingFundFrom = function(req,res){
	var name = req.body.name;
	var address = auth.generateAddress(req.body.email, walletPrefix);
	var walletAddress = address;
...
TNC_RRWallet.getTNCStakingFundList = function(req,res){
	var name = req.body.name;
...
TNC_RRWallet.getTNCWalletHistory = function(req,res){
...
TNC_RRWallet.getTNCWalletInfo = function(req,res){
	var username = req.body.email;	
...
TNC_RRWallet.transferLockTNCWallet = function(req,res) {
...
TNC_RRWallet.getTransferLockFrom = function(req,res){
	var from = req.body.email;
...
TNC_RRWallet.getTransferLockTo = function(req,res){
...
TNC_RRWallet.checkAccount = function(req,res) {
	/*
